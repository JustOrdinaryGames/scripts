...
function Rainbowify(name)
	while RunService.Stepped:Wait() and not killScript do
		for hue = 0, 1, 0.06 do
			if not name:IsA("Weld") then
...
local function GHK(char)
	...
	if soidk~=nil then if soidk.Character and soidk~=Player and tostring(soidk)~="CKBackup"then
...
local function FindHumanoid(Part)local humanoid=nil if Part.Parent then if Part.Parent~=miztgetcharacter() and Part.Parent:FindFirstChildOfClass("Humanoid")~=nil then humanoid=Part.Parent:FindFirstChildOfClass("Humanoid")else if Part.Parent.Parent then if Part.Parent.Parent:FindFirstChildOfClass("Humanoid")and Part.Parent.Parent~=miztgetcharacter() then humanoid=Part.Parent.Parent:FindFirstChildOfClass("Humanoid")end end end end if humanoid==Humanoid then humanoid=nil end return humanoid end  
...
local Handle = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.2,0.6,0.2),false)
...
Align(Hat.Handle,Handle,Vector3.new(0,-0.5,1.1),Vector3.new(-180,-90,45))
local RightArmGrasp = CreateWeldOrSnapOrMotor("Weld", Handle, RightArm, Handle, CF(0,-1, 0) * ANGLES(RAD(90), RAD(0), RAD(0)), CF(0, 0.21, 0))
spawn(function() Rainbowify(RightArmGrasp) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.2,0.5,0.2),false)
MakeForm(Part,"Wedge")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.3, 0.2) * ANGLES(RAD(0), RAD(180), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.2,0.3,0.2),false)
MakeForm(Part,"Wedge")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.4, 0) * ANGLES(RAD(0), RAD(0), RAD(180)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.3,0.3,0.3),false)
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.5, 0.2) * ANGLES(RAD(0), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.3,0.5,0.5),false)
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 0.5) * ANGLES(RAD(0), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.4,0.4,0.4),false)
MakeForm(Part,"Cyl")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 0.5) * ANGLES(RAD(90), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
for i = 1, 8 do
	local Piece = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Eye", VT(0,0.35,0.41),false)
	CreateWeldOrSnapOrMotor("Weld", Handle, Part, Piece, CF(0, 0, 0) * ANGLES(RAD(0), RAD((360/8)*i), RAD(0)), CF(0, 0, 0))
	spawn(function() Rainbowify(Piece) end)
end
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Eye", VT(0.38,0.41,0.38),false)
MakeForm(Part,"Cyl")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 0.5) * ANGLES(RAD(90), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.37,0.5,0.37),false)
MakeForm(Part,"Ball")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 0.3) * ANGLES(RAD(90), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.2,0.7,0.4),false)
MakeForm(Part,"Wedge")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.7, 0.5) * ANGLES(RAD(90), RAD(180), RAD(180)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.3,0.4,0.2),false)
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 0.7) * ANGLES(RAD(0), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.35,0.35,0.35),false)
MakeForm(Part,"Cyl")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 0.7) * ANGLES(RAD(90), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.5,0.1,0.5),false)
MakeForm(Part,"Cyl")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 1) * ANGLES(RAD(90), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.5,0.1,0.45),false)
MakeForm(Part,"Cyl")
...
for i = 1, 10 do
	if LASTPART == Handle then
		local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.1,0.2,0),false)
		LASTPART = Part
		CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.1, 0.2) * ANGLES(RAD(90), RAD(0), RAD(0)), CF(0, 0, 0))
		spawn(function() Rainbowify(Part) end)
	else
		local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.1,0.05,0),false)
...
local Barrel = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.15,4,0.15),false)
MakeForm(Barrel,"Cyl")
...
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0.25,2,0.25),false)
MakeForm(Part,"Cyl")
CreateWeldOrSnapOrMotor("Weld", Handle, Barrel, Part, CF(0, -0.2, 0), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0,0.1,0.2),false)
MakeForm(Part,"Wedge")
CreateWeldOrSnapOrMotor("Weld", Handle, Barrel, Part, CF(0, 0.945, 0.1) * ANGLES(RAD(180), RAD(0), RAD(0)), CF(0, 0, 0))
spawn(function() Rainbowify(Part) end)
local Hole = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Eye", VT(0.125,0,0.125),false)
MakeForm(Hole,"Cyl")
CreateWeldOrSnapOrMotor("Weld", Handle, Barrel, Hole, CF(0, 2, 0), CF(0, 0, 0))
spawn(function() Rainbowify(Hole) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Part", VT(0,0,0),false)
spawn(function() Rainbowify(Part) end)
local GEARWELD = CreateWeldOrSnapOrMotor("Weld", Handle, Handle, Part, CF(0, -0.6, 0.7), CF(0, 0, 0))
CreateMesh("SpecialMesh", Part, "FileMesh", 156292343, "", VT(0.8,0.8,1.5), VT(0,0,0.2))
spawn(function() Rainbowify(GEARWELD) end)
local Part = CreatePart(3, Weapon, "ForceField", 0, 1, "Mid gray", "Eye", VT(0,0,0),false)
spawn(function() Rainbowify(Part) end)
...
function chatfunc(text)
	local chat = coroutine.wrap(function()
		...
		coroutine.resume(coroutine.create(function()
			while Hehe ~= nil and not killScript do
				Swait()	
...
function notifymsg(Name)
	local MESSAGES = {"Chill, ",
		"BEGONE, ", "Try it again, ", "Don't try that ever again, "}
		...
		repeat
			...
			if HIT ~= nil then
				if HIT.Parent:FindFirstChildWhichIsA("Humanoid") then
                    ...
                    coroutine.wrap(function() wait(1) flingTarget = miztgetcharacter() end)()
                elseif HIT.Parent.Parent:FindFirstChildWhichIsA("Humanoid") then
                    flingTarget = HIT.Parent.Parent
                    coroutine.wrap(function() wait(1) flingTarget = miztgetcharacter() end)()
                end
			end
			for i=0, 0.01, 0.1 / Animation_Speed do
...
function Rush()
	...
	CreateWave2(VT(1,1,1),65,CF(RootPart.Position)*CF(0,-3,0),false,2,"Pearl",VT(0.2,1,0.2))
	spawn(function() Rainbowify(RootPart) end)
...
function KeyDown(Key)
	...
	if Key == "m" and ATTACK == false and BanishMode == 2 then
		...
		chatfunc("WELL...")
		wait(3)
		title("YOU GONNA HAVE A VERY BAD TIME")
...
while true and not killScript do
	...
	elseif TORSOVELOCITY > 3.5 and HITFLOOR ~= nil and Rooted == false then
		ANIM = "Walk"
