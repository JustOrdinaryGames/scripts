local script = game:GetObjects("rbxassetid://5731205669")[1]
...
script.MegaGunnModel.Parent = Character
...
local GunJoint = Instance.new("Weld", GUN.Joint)
GunJoint.Part0 = RightArm
GunJoint.Part1 = GUN.Joint
local Count = 1
function Align(Part0,Part1,Position,Angle)
    ...
    coroutine.wrap(function()
        while wait() and not stopeverything do
...
Align(Hat.Handle,GUN.Joint,Vector3.new(0,0.6,-1),Vector3.new(0,90,45))
local Hole = GUN.Hole
...
local songpitch = 1
local tauntval = "None"
local songid = "rbxassetid://3247404955"
local eee = Instance.new("Sound",Torso)
eee.Volume = songvolume
eee.Pitch = songpitch
eee.SoundId = songid
eee:Play()
...
function taunt(taunt,tauntid)
	if stopeverything then return end
	tauntval = taunt
	if songid ~= "rbxassetid://"..tostring(tauntid) then
		songid = "rbxassetid://"..tostring(tauntid)
	end
	songpitch = 1
...
function chatfunc(textt,glitchy)
	...
	local chat = coroutine.wrap(function()
		if Head:FindFirstChild("TalkingBillBoard") then
			Head:FindFirstChild("TalkingBillBoard"):Destroy()
		end
		local sayingstuff = Instance.new("BillboardGui",Head)
...
game.Players.LocalPlayer.Chatted:Connect(chatfunc)
if stopeverything then return end
...
Mouse.Button1Down:Connect(function()
	if stopeverything then return end
	if attack == false and (tauntval == "None" or tauntval == "iNSaNiTY" or tauntval == "Err0r" or tauntval == "FAST BOIII" or tauntval == "Glitch") then
		attackone()
	end
end)
local FLYING = false
...
Mouse.KeyDown:Connect(function(k)
	if stopeverything then return end
	k = k:lower()
	if k == "z" and attack == false and (tauntval == "None" or tauntval == "iNSaNiTY" or tauntval == "Err0r" or tauntval == "FAST BOIII" or tauntval == "Glitch") then	
		hedshoot()
	elseif k == "x" and attack == false and (tauntval == "None" or tauntval == "iNSaNiTY" or tauntval == "Err0r" or tauntval == "FAST BOIII" or tauntval == "Glitch") then
		SingularityBeam()
	elseif k == "c" and attack == false and (tauntval == "None" or tauntval == "iNSaNiTY" or tauntval == "Err0r" or tauntval == "FAST BOIII" or tauntval == "Glitch") then
		painlessrain()
	elseif k == "v" and attack == false and (tauntval == "None" or tauntval == "iNSaNiTY" or tauntval == "Err0r" or tauntval == "FAST BOIII" or tauntval == "Glitch") then
		attacktwo()
	elseif k == "b" and attack == false and (tauntval == "None" or tauntval == "iNSaNiTY" or tauntval == "Err0r" or tauntval == "FAST BOIII" or tauntval == "Glitch") then
		Ka_Boom()
	elseif k == "m" then
		if songid ~= "rbxassetid://3247404955" and songid ~= "rbxassetid://5315171837" and songid ~= "rbxassetid://262950484" and songid ~= "rbxassetid://481104377" and songid ~= "rbxassetid://2920078671" then
			taunt("None",3247404955)
		elseif songid == "rbxassetid://3247404955" then
			taunt("None",5315171837)
		elseif songid == "rbxassetid://5315171837" then
			taunt("sAnIty",262950484)
			songid = "rbxassetid://262950484"
			repeat if stopeverything then return end 
				game:GetService("RunService").RenderStepped:Wait()
			until eee.TimePosition >= 24 or songid ~= "rbxassetid://262950484"
			if songid == "rbxassetid://262950484" then
				chatfunc(" ")
				...
				taunt("iNSaNiTY",262950484)
			end
		elseif songid == "rbxassetid://262950484" then
			taunt("Err0r",481104377)
		elseif songid == "rbxassetid://481104377" then
			taunt("FAST BOIII",2920078671)
		elseif songid == "rbxassetid://2920078671" then
			taunt("Glitch",2297862957)
		end
	elseif k == "f" then
...
function fly()
    ...
    --l1.Name = "l1"
    --r1.Name = "r1"
    local Hat = AlignChar:FindFirstChild("SoloWing")

    if Hat.Handle:FindFirstChild("AccessoryWeld") then
        Hat.Handle.AccessoryWeld:Destroy()
    end
    Align(Hat.Handle,l1,Vector3.new(-0.1,1.6,0),Vector3.new(0,0,60))
    local AlignChar = miztgetcharacter()
    local Hat = AlignChar:FindFirstChild("SoloWing2")

    if Hat.Handle:FindFirstChild("AccessoryWeld") then
        Hat.Handle.AccessoryWeld:Destroy()
    end
    Align(Hat.Handle,r1,Vector3.new(-0.1,1.6,0),Vector3.new(0,190,-60))
	local oc0 = {}
...
while not stopeverything do
	...
	if eee.Volume ~= songvolume then
		eee.Volume = songvolume
	end
	if eee.Pitch ~= songpitch then
		eee.Pitch = songpitch
	end
	if eee.SoundId ~= songid then
		eee.SoundId = songid
	end
	...
	for i,v in pairs(Character:GetDescendants()) do
		if v:IsA("BasePart") then
			if not v:IsDescendantOf(Effects) and v ~= RootPart then
				v.Anchored = false
			elseif v == RootPart and true then
				v.Anchored = false
			elseif v == RootPart then
				v.Anchored = true
			end
		end
	end
	...
	if tauntval == "None" or tauntval == "sAnIty" then
		if tauntval == "sAnIty" then
		...
		if not Character:FindFirstChild("WalkingWheel") and Anim == "Idle" and attack == false then
			...
			coroutine.resume(coroutine.create(function()
				repeat if stopeverything then return end 
					...
					swait() 
				until attack or Anim ~= "Idle" or tauntval ~= "FAST BOIII"
				alreadyfixing = true
				ww:Destroy()
				alreadyfixing = false
			end))
