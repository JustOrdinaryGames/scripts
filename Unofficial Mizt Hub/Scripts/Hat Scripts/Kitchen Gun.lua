...
bgmusic.Looped = true
bgmusic.Parent = miztgetcharacter().Torso
bgmusic:Play()
...
local Hat = AlignChar:FindFirstChild("Meshes/1911RightAccessory")
...
Align(Hat.Handle,gun,Vector3.new(0,0.05,-0.15),Vector3.new(-90,180,0))
...
addattack("MouseClick", function()
	if not attacking then
		...
		local hit,position = workspace:FindPartOnRayWithIgnoreList(ray, {char, gun, game.Players.LocalPlayer.Character})
